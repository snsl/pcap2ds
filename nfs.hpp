/* nfs.hpp
 *
 * Definitions for converting NFS pcap files to DataSeries files
 *
...
/*------------------------------------------------
 * Definition of subclass nfs, built from the Protocol class
 *------------------------------------------------*/
class nfs : public Protocol{
protected:
	static Int32Field *recommended_attr_field;
	static Int32Field *reply_status_field;

	static const string nfs_xml;
