/* smb.hpp
 *
 * Definitions for converting SMB pcap files to DataSeries files
 *
...
/*-----------------------------------------------------
 * Definition of subclass smb, built from the Protocol class
 *-----------------------------------------------------*/
class smb : public Protocol {
protected:
	static Int64Field *current_offset_field;
	static Int64Field *alloc_size64_field;

	static const string smb_xml;
